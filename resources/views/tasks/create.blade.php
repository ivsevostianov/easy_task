                ...
                <form action="{{ route('tasks.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Description (optional) - <span id="char-count" class="text-gray-500">0/500</span>
                        </label>
                    ...
                    <button type="submit"
                            class="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200 transform hover:scale-105">
                        Create Task
                    </button>
                </form>
            </div>
